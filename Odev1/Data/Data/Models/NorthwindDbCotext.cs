...
public partial class NorthwindDbCotext : DbContext
{
    public NorthwindDbCotext()
    {
    }

    public NorthwindDbCotext(DbContextOptions<NorthwindDbCotext> options)
        : base(options)
    {
    }
    ...
    {
        optionsBuilder.UseSqlServer("Server=F3-LAPTOP;Database=Northwind;Trusted_Connection=True;Encrypt=False");
    }
